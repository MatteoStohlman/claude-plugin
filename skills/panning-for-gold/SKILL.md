...
5. **Connections:** How does this connect to their existing thinking? (Use search_thoughts to find related Vello entries.)
6. **Verdict:** One of:
...
## Phase 3.5: Capture to Vello

After writing the gold-found file, capture to Vello automatically (do not ask).
...
This closes the flywheel: panning extracts and evaluates, Vello stores, Gate 0 finds it next session.
